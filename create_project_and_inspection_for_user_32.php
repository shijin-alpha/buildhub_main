...
try {
    ...
    // Create a project for user 32
    $projectName = $user['first_name'] . ' ' . $user['last_name'] . ' Construction Project';
    $stmt = $db->prepare('
        INSERT INTO construction_projects (
            homeowner_id, homeowner_name, project_name, project_location, 
            status, current_stage, completion_percentage, contractor_id,
    ...
    $stmt->execute([
        ...
        19 // contractor_id (using existing contractor)
    ]);
