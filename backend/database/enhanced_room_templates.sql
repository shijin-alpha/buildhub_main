-- Enhanced Room Templates with Walkways, Staircases, Doors, and Better Color Coding
...
-- Doors and Openings (Light Blue tones) - NEW CATEGORY
('Main Door', 'doors', 4, 1, 3, 0.5, 6, 1.5, '#b3d9ff', '🚪'),
('Interior Door', 'doors', 3, 1, 2.5, 0.5, 4, 1.5, '#cce7ff', '🚪'),
('Sliding Door', 'doors', 6, 1, 4, 0.5, 8, 1.5, '#e0f2ff', '🚪'),
('French Door', 'doors', 5, 1, 4, 0.5, 7, 1.5, '#f0f8ff', '🚪'),
('Folding Door', 'doors', 8, 1, 6, 0.5, 10, 1.5, '#e6f3ff', '🚪'),
('Window', 'doors', 4, 1, 2, 0.5, 8, 1.5, '#d9ecff', '🪟'),
('Bay Window', 'doors', 6, 2, 4, 1, 10, 3, '#ccdfff', '🪟'),
('Arch Opening', 'doors', 4, 1, 3, 0.5, 6, 1.5, '#bfd6ff', '🏛️'),
