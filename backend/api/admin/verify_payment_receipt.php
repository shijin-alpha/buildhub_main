...
try {
    ...
    try {
        ...
        try {
            ...
            $blockchainResult = $blockchainIntegrator->recordAdminReceiptVerification(
                $blockchainPaymentData, 
                $blockchainVerificationData
            );
            
            if ($blockchainResult) {
                error_log("Admin receipt verification successfully recorded on blockchain: Payment ID {$payment_id}, Hash: {$blockchainResult}");
            }
