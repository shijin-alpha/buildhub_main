...
try {
    ...
    // NOTE: ai_cost_risk_level, ai_time_risk_level, ai_risk_score, ai_prediction_data are intentionally
    // excluded from this query — architects do not receive time/cost prediction details.
    $query = "SELECT 
