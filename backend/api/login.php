...
// Check verification for contractor/architect/site_inspector
if (($user['role'] === 'contractor' || $user['role'] === 'architect' || $user['role'] === 'site_inspector') && !$user['is_verified']) {
...
switch ($user['role']) {
    ...
    case 'architect':
        ...
        break;
    case 'site_inspector':
        $response['redirect'] = 'site-inspector-dashboard';
        break;
    default:
        $response['redirect'] = 'login';
}
