...
import SiteInspectionDashboard from './SiteInspectionDashboard.jsx';
    ...
    <div className="dashboard-container admin-modern">
      ...
      <div className={`dashboard-sidebar soft-sidebar expanded ${sidebarOpen ? 'open' : ''}`}>
        ...
        <nav className="sidebar-nav sb-nav">
          ...
          <a 
            href="#" 
            className={`nav-item sb-item ${activeTab === 'site-inspection' ? 'active' : ''}`}
            onClick={(e) => { e.preventDefault(); setActiveTab('site-inspection'); }}
          >
            <span className="nav-icon sb-icon"><Icon name="clipboard" /></span>
            Site Inspection
          </a>
          <a 
            href="#" 
      ...
      <div className="dashboard-main soft-main shifted">
        ...
        <div className="admin-layout">
          <div className="admin-center" style={{paddingRight: '12px'}}>
            ...
            {activeTab === 'site-inspection' && <SiteInspectionDashboard />}
            {activeTab === 'reports' && (
