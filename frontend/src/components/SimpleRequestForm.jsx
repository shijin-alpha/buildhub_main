...
const SimpleRequestForm = ({ onClose, onSubmit }) => {
  const { notifications, removeNotification, showSuccess, showError } = useNotifications();
  
  // Form state - simplified without AI features
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (result.success) {
        showSuccess('Success!', 'Your construction request has been submitted successfully!');
  ...
  const renderStep3 = () => (
    <div className="form-step">
      ...
      <p>Choose architects to receive your construction request</p>
    ...
    <div className="enhanced-request-form-overlay">
      <div className="enhanced-request-form">
        <div className="form-header">
          <h2>🏠 Create Construction Request</h2>
