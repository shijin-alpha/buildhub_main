...
// Custom ProfilePopup for Homeowner Dashboard
const HomeownerProfilePopup = ({ isOpen, onClose, user, position, onProfileSetup, onLogout }) => {
...
export default HomeownerProfileButton;
