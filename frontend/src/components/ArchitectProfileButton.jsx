...
// Custom ProfilePopup for Architect Dashboard
const ArchitectProfilePopup = ({ isOpen, onClose, user, position, onProfileSetup, onLogout }) => {
...
export default ArchitectProfileButton;
