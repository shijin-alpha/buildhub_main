  ...
  const initiateAlternativePayment = async (methodKey, method) => {
    try {
      ...
      if (data.success) {
        ...
        // Don't call onPaymentInitiated here - only call it when payment is actually completed
        // The payment flow should continue to show instructions and receipt upload
      } else {
